...
function selectAnswer(selected, correctAnswer, button) {
    ...
    if (selected === correctAnswer) {
        ...
        button.style.color = "white"; // Met en vert le bouton de réponse correcte
    } else {
        button.style.backgroundColor = "darkred"; // Met en rouge le bouton de réponse incorrecte
        button.style.color = "white"; // Met en vert le bouton de réponse correcte
    }

    // Attendez 3 secondes avant de passer à la question suivante
    setTimeout(() => {
...
function endQuiz() {
    ...
    container.innerHTML = `
        ...
        <div class="end-quiz-buttons">
            <button id="restartQuizButton">Recommencer le Quiz</button>
